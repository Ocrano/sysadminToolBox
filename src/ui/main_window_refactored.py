...
class MainWindowRefactored(QMainWindow):
    ...
    def __init__(self, git_manager, script_runner, proxmox_handler):
        ...
        self.controller = MainController(git_manager, script_runner, proxmox_handler)
    ...
    def add_external_tabs(self):
        ...
        try:
            ...
            scanner_tab = NetworkScannerTab(self, self.controller.proxmox_handler)
    ...
    def open_qemu_agent_manager(self):
        ...
        dialog = QemuAgentManagerDialog(self, self.controller.proxmox_handler)
        dialog.exec()

    def list_all_vms(self):
        """Liste toutes les VMs"""
        vms = self.controller.proxmox_handler.list_vms()
    ...
    def scan_linux_vms(self):
        ...
        linux_vms = self.controller.proxmox_handler.get_linux_vms()
    ...
    def show_nodes_status(self):
        ...
        statuses = self.controller.proxmox_handler.get_node_status()
    ...
    def show_storage_info(self):
        ...
        storages = self.controller.proxmox_handler.get_storage_info()
